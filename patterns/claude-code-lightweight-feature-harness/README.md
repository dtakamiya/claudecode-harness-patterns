...
![小規模機能を短い工程で安全に完成させる軽量機能追加ハーネスの概要](docs/images/overview.png)
...
2. **Branch / Baseline:** main/master以外のfeatureブランチを用意し、既存実装と検証コマンドをread-onlyで確認して変更前baselineを記録する。
...
機能文書を作る場合は原則`docs/features/<feature-id>/`へまとめます。3方式の選択は[共通適用ガイド](../README.md)を参照してください。
